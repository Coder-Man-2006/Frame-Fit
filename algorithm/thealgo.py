...
class FaceAnalyzer:
    ...
    def run(self):
        ...
        measurement_columns = ["Length of Face", "Temple to Temple", "Cheekbone to Cheekbone", "Jawline", 'Time']
        ...
        while True:
            ...
            measurements = [distances[0], distances[1], distances[2], distances[3], elapsed_time_seconds]
